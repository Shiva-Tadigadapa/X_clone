...
import { googleAuth, login, sendOtp, verifyOtp, verifyToken, refreshToken ,getRandomUsers,getSearchResults } from '../Controllers/AuthControllers.js';
...
authRoutes.get('/search/:search', getSearchResults );
